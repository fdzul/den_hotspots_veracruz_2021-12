...
```{r, dpi=300,echo=FALSE, fig.alt=1,fig.align ="center", out.height="70%", out.width = "90%"}
DiagrammeR::grViz("digraph {
...
```{r, echo=FALSE,dpi=300,  fig.alt=1, fig.align ="center",out.height="70%", out.width = "90%"}
DiagrammeR::grViz("digraph {
...
load("C:/Users/Usuario/OneDrive/proyects/hotspots/8.RData/cases_hotspots_agebs19.RData")
cases_hotspots_agebs19 <- cases_hotspots_agebs19 |> sf::st_make_valid()
source("C:/Users/Usuario/Dropbox/r_developments/r_dashboards/github_pages/test_dashboard/3.Functions/hotspots_map.R")
...
source("C:/Users/Usuario/Dropbox/r_developments/r_dashboards/github_pages/test_dashboard/3.Functions/hotspots_eggs_intensity.R")

# Step 3. plot the hotspots eggs intensity Guadalajara ####
# Step 3.1 load the hotspots eggs dataset Guadalajara ####
load("C:/Users/Usuario/OneDrive/proyects/hotspots/8.RData/eggs_hotspots_historic/14_Jalisco/14_guadalajara_k20_zinb1.RData")
...
load("C:/Users/Usuario/Dropbox/manual_hotspots_veracruz/9.cas&geo_files/Xalapa de Enriquez302019.RData")
...
.center[
![:gen 90%, shadow](C:/Users/Usuario/Dropbox/r_developments/r_dashboards/github_pages/test_dashboard/6.Maps/lgcp_map/lgcp_xalapa.jpg)
]

--- 

### Hotspots de los casos y Hotspots del vector

.center[
![:gen 90%, shadow](C:/Users/Usuario/Dropbox/r_developments/r_dashboards/github_pages/test_dashboard/6.Maps/stacked_map/stacked_maps_cases.jpg)
]
