...
### Algoritmo para la identificación de los Hotspots de los Casos
...
```{r,echo=FALSE,dpi=300, warning = FALSE,message = FALSE, fig.align ="center", out.width = "80%",fig.cap = "Hotspots de la transmisión de dengue en el área metropolitana de Guadalajara."}
